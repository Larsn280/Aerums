        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsConfirmedHostingUser = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsConfirmedAttendingUser = table.Column<bool>(type: "INTEGER", nullable: false),
                    Place = table.Column<string>(type: "TEXT", nullable: true),
                    Note = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingModel", x => x.BookingsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreeTimeModel", x => x.FreeTimeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingModelBookingsId = table.Column<int>(type: "INTEGER", nullable: true),
                    FreeTimeModelFreeTimeId = table.Column<int>(type: "INTEGER", nullable: true),
